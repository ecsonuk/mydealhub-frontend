  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-12">
      ...
      <div className="space-y-6 text-gray-700 leading-8">
        ...
        <p>
          We strive to keep deal information accurate and up to date.
          However, prices, availability and promotions may change
          without notice and are ultimately controlled by the merchant.
        </p>
        ...
        <p>
          ...
          any time. Updates will be published on this page.
        </p>
