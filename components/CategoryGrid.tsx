      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-5">
        ...
        {categories.slice(0, 12).map((category) => (
          <Link
            ...
            className="bg-white rounded-2xl p-5 text-center shadow-md border border-slate-100 hover:shadow-2xl hover:border-blue-200 hover:-translate-y-2 transition-all duration-300 group"
          >
